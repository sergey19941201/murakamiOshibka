...
namespace Murakami
{
    [Activity(Label = "CaliforniaActivity")]
    public class CaliforniaActivity : Activity
    {
        protected override void OnCreate(Bundle bundle)
        {
            base.OnCreate(bundle);
            SetContentView(Resource.Layout.California);
            ...
            var filename = System.IO.Path.Combine(path, "cache2.txt");
            JsonValue readJson;
        ...
        private async void ParseAndDisplay(JsonValue readJson)
        {
            ...
            add.Click += delegate
            {
                var intent = new Intent(this, typeof(rollSlivochnayaCaliforniaSUgrem));
                StartActivity(intent);
            };
        ...
        private async void ParseAndDisplay1(JsonValue readJson)
        {
            ...
            add1.Click += delegate
            {
                var intent = new Intent(this, typeof(rollCaliforniyskiySTuntsom));
                StartActivity(intent);
            };
        ...
        private async void ParseAndDisplay2(JsonValue readJson)
        {
            ...
            add2.Click += delegate
            {
                var intent = new Intent(this, typeof(rollCaliforniyskiySTempuraKrevietkoy));
                StartActivity(intent);
            };
        ...
        private async void ParseAndDisplay3(JsonValue readJson)
        {
            ...
            add3.Click += delegate
            {
                var intent = new Intent(this, typeof(rollCaliforniyskiySLososem));
                StartActivity(intent);
            };
        ...
        private async void ParseAndDisplay4(JsonValue readJson)
        {
            ...
            add4.Click += delegate
            {
                var intent = new Intent(this, typeof(rollCaliforniyskiySUgrem));
                StartActivity(intent);
            };
        ...
        private async void ParseAndDisplay5(JsonValue readJson)
        {
            ...
            add5.Click += delegate
            {
                var intent = new Intent(this, typeof(rollCaliforniyskiyOstriySLososemVStruzhkeTuntsaa));
                StartActivity(intent);
            };
