...
namespace Murakami
{
    [Activity(Label = "zharinayaKrahmalnayaLapshaSTeliatinoyPodImbirnoSoevimSousom")]
    public class zharinayaKrahmalnayaLapshaSTeliatinoyPodImbirnoSoevimSousom : Activity
    {
