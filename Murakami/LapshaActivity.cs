...
namespace Murakami
{
    [Activity(Label = "LapshaActivity")]
    public class LapshaActivity : Activity
    {
        protected override void OnCreate(Bundle bundle)
        {
            base.OnCreate(bundle);
            SetContentView(Resource.Layout.Lapsha);

            var path = System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments);
            var filename = System.IO.Path.Combine(path, "cache8.txt");
            JsonValue readJson;
        ...
        private async void ParseAndDisplay(JsonValue readJson)
        {
            ...
            add.Click += delegate
            {
                var intent = new Intent(this, typeof(zharenayaLapshaSTeliatinoyPodPerechnimSousom));
        ...
        private async void ParseAndDisplay1(JsonValue readJson)
        {
            ...
            add1.Click += delegate
            {
                var intent = new Intent(this, typeof(zharinayaKrahmalnayaLapshaSTeliatinoyPodImbirnoSoevimSousom));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay2(JsonValue readJson)
        {
            ...
            add2.Click += delegate
            {
                var intent = new Intent(this, typeof(shafranovayaLapshaSMoreproduktami));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay3(JsonValue readJson)
        {
            ...
            add3.Click += delegate
            {
                var intent = new Intent(this, typeof(zharennayaUdonLapshaSTeliatinoyIOvoshchamiVUstrichnomSouse));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay4(JsonValue readJson)
        {
            ...
            add4.Click += delegate
            {
                var intent = new Intent(this, typeof(zharennayaUdonLapshaSKuritseyIOvoshchamiVUstrichnomSouse));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay5(JsonValue readJson)
        {
            ...
            add5.Click += delegate
            {
                var intent = new Intent(this, typeof(zharennayUdonLapshaSKuritseyIOvoshchamiVSouseHoyshin));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay6(JsonValue readJson)
        {
            ...
            add6.Click += delegate
            {
                var intent = new Intent(this, typeof(zharennayaKrahmalnayaLapshaSKuritseyVKisloSladkomSouse));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay7(JsonValue readJson)
        {
            ...
            add7.Click += delegate
            {
                var intent = new Intent(this, typeof(zharenayaKrahmalnayaLapshaSOvoshchami));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
