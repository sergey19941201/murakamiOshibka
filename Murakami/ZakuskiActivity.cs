...
namespace Murakami
{
    ...
    public class ZakuskiActivity : Activity
    {
        ...
        private async void ParseAndDisplay(JsonValue readJson)
        {
            ...
            add.Click += delegate
            {
                var intent = new Intent(this, typeof(tatakiTunetsSSousomVafu));
                StartActivity(intent);
            };
        ...
        private async void ParseAndDisplay1(JsonValue readJson)
        {
            ...
            add1.Click += delegate
            {
                var intent = new Intent(this, typeof(pelmeniGedzuSKuritseyIKrevetkoy));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay2(JsonValue readJson)
        {
            ...
            add2.Click += delegate
            {
                var intent = new Intent(this, typeof(pelmeniGedzuSKuritsey));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay3(JsonValue readJson)
        {
            ...
            add3.Click += delegate
            {
                var intent = new Intent(this, typeof(kalmarKarageSChiliTsitrusovimSousom));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay4(JsonValue readJson)
        {
            ...
            add4.Click += delegate
            {
                var intent = new Intent(this, typeof(dimSamiSkuritseyIKrevietkoy));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay5(JsonValue readJson)
        {
            ...
            add5.Click += delegate
            {
                var intent = new Intent(this, typeof(dimSamiSKuritsey));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay6(JsonValue readJson)
        {
            ...
            add6.Click += delegate
            {
                var intent = new Intent(this, typeof(harGaySKuritsey));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay7(JsonValue readJson)
        {
            ...
            add7.Click += delegate
            {
                var intent = new Intent(this, typeof(harGauSKuritseyIKrevietkoy));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay8(JsonValue readJson)
        {
            ...
            add8.Click += delegate
            {
                var intent = new Intent(this, typeof(chipsiRisovieKrevietochnie));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay9(JsonValue readJson)
        {
            ...
            add9.Click += delegate
            {
                var intent = new Intent(this, typeof(teriakiLososSListiamiZelenogogSalataIAvokado));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay10(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(zakuskaLososiaIzSiromFiladelfia));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay11(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(krabovieMeshochki));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay12(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(hrustkiyKalmarIzSpaysiSousom));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay13(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(prianieZharenieKrevietkiSSousomAvokadoIKimchi));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay14(JsonValue readJson)
        {
            ...
            add14.Click += delegate
            {
                var intent = new Intent(this, typeof(kokosovieLepeshkiSChesnochnimSousom));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay15(JsonValue readJson)
        {
            ...
            add15.Click += delegate
            {
                var intent = new Intent(this, typeof(zharennieLomtikiSiraSKliukvennimSousom));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay16(JsonValue readJson)
        {
            ...
            add16.Click += delegate
            {
                var intent = new Intent(this, typeof(yaponskiyOmletSOvochiami));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
