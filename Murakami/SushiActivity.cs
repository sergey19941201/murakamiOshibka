...
namespace Murakami
{
    [Activity(Label = "SushiActivity", Icon = "@drawable/icon", Theme = "@android:style/Theme.Black.NoTitleBar", ScreenOrientation = ScreenOrientation.Portrait)]
    public class SushiActivity : Activity
    {
        protected override void OnCreate(Bundle bundle)
        {
            base.OnCreate(bundle);
            SetContentView(Resource.Layout.Sushi);

            var path = System.Environment.GetFolderPath(System.Environment.SpecialFolder.MyDocuments);
            var filename = System.IO.Path.Combine(path, "cache17.txt");
            JsonValue readJson;
        ...
        private async void ParseAndDisplay(JsonValue readJson)
        {
            ...
            add.Click += delegate
            {
                var intent = new Intent(this, typeof(sushiAvokado));
        ...
        private async void ParseAndDisplay1(JsonValue readJson)
        {
            ...
            add1.Click += delegate
            {
                var intent = new Intent(this, typeof(sushiTuniets));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay2(JsonValue readJson)
        {
            ...
            add2.Click += delegate
            {
                var intent = new Intent(this, typeof(sushiTigrovaKrivietka));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay3(JsonValue readJson)
        {
            ...
            add3.Click += delegate
            {
                var intent = new Intent(this, typeof(sushiSladkiyOmlet));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay4(JsonValue readJson)
        {
            ...
            add4.Click += delegate
            {
                var intent = new Intent(this, typeof(sishiOsminog));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay5(JsonValue readJson)
        {
            ...
            add5.Click += delegate
            {
                var intent = new Intent(this, typeof(sushiLosos));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay6(JsonValue readJson)
        {
            ...
            add6.Click += delegate
            {
                var intent = new Intent(this, typeof(sushiUgorKopcheniy));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay7(JsonValue readJson)
        {
            ...
            add7.Click += delegate
            {
                var intent = new Intent(this, typeof(sushiKalmar));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay8(JsonValue readJson)
        {
            ...
            add8.Click += delegate
            {
                var intent = new Intent(this, typeof(sushiSpaisiTunets));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay9(JsonValue readJson)
        {
            ...
            add9.Click += delegate
            {
                var intent = new Intent(this, typeof(sushiSpaisiLosos));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay10(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(sushiSpaisiKopcheniyLosos));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay11(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(sushiSpaisiKalmarSIkroyTobiko));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay12(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(spaisiSushi));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay13(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(sushiOsminogSIkroyTobiko));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay14(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(sushiMarinovannieVodoroski));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay15(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(sushiIkraTobiko));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
