...
namespace Murakami
{
    [Activity(Label = "OsnovniBludaActivity")]
    public class OsnovniBludaActivity : Activity
    {
        protected override void OnCreate(Bundle bundle)
        {
            base.OnCreate(bundle);
            SetContentView(Resource.Layout.OsnovniBluda);
            ...
            var filename = System.IO.Path.Combine(path, "cache11.txt");
            JsonValue readJson;
        ...
        private async void ParseAndDisplay(JsonValue readJson)
        {
            ...
            add.Click += delegate
            {
                var intent = new Intent(this, typeof(keykSLosossem));
                StartActivity(intent);
            };
        ...
        private async void ParseAndDisplay1(JsonValue readJson)
        {
            ...
            add1.Click += delegate
            {
                var intent = new Intent(this, typeof(kurinoeBedroPoPekinskiSMarinovanimOgurtsomVasabi));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay2(JsonValue readJson)
        {
            ...
            add2.Click += delegate
            {
                var intent = new Intent(this, typeof(tsiplionokVAziatskomSouseSOvoshcami));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay3(JsonValue readJson)
        {
            ...
            add3.Click += delegate
            {
                var intent = new Intent(this, typeof(keykSLososem));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay4(JsonValue readJson)
        {
            ...
            add4.Click += delegate
            {
                var intent = new Intent(this, typeof(teliatinaSOvoshchamiVSousePepper));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay5(JsonValue readJson)
        {
            ...
            add5.Click += delegate
            {
                var intent = new Intent(this, typeof(svinieRebraVAsiatskomStile));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay6(JsonValue readJson)
        {
            ...
            add6.Click += delegate
            {
                var intent = new Intent(this, typeof(kuriniyRuletSTempuraOvoshchamiIyablochnimChatni));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay8(JsonValue readJson)
        {
            ...
            add8.Click += delegate
            {
                var intent = new Intent(this, typeof(risZhareniySKuritsey));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay9(JsonValue readJson)
        {
            ...
            add9.Click += delegate
            {
                var intent = new Intent(this, typeof(risZhareniySKrevetkami));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay10(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(risZharenniySGribamiIYaytsom));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay11(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(RisGohan));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay12(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(teriyakiKuritsa));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay13(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(spaisiLososSZhasminovimRisom));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay14(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(svininaNaKisttziZKartoplianimPure));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay15(JsonValue readJson)
        {
            ...
            {
                var intent = new Intent(this, typeof(kariSKuritseyIParovimRisom));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
