...
namespace Murakami
{
    [Activity(Label = "FiladelfiaActivity")]
    public class FiladelfiaActivity : Activity
    {
        protected override void OnCreate(Bundle bundle)
        {
            base.OnCreate(bundle);
            SetContentView(Resource.Layout.Filadelfia);
            ...
            var filename = System.IO.Path.Combine(path, "cache6.txt");
            JsonValue readJson;
        ...
        private async void ParseAndDisplay(JsonValue readJson)
        {
            ...
            add.Click += delegate
            {
                var intent = new Intent(this, typeof(rollSLososemMarinovanimiVodorosliamiISiromFiladelfia));
                StartActivity(intent);
            };
        ...
        private async void ParseAndDisplay1(JsonValue readJson)
        {
            ...
            add1.Click += delegate
            {
                var intent = new Intent(this, typeof(rollFiladelfiaSMarinovanimLososem));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
        ...
        private async void ParseAndDisplay2(JsonValue readJson)
        {
            ...
            add2.Click += delegate
            {
                var intent = new Intent(this, typeof(rollFiladelfiaSKopchenimLososem));
                StartActivity(intent);
            };
            // Zagruska detalnogo prosmotra, ego poka net
            /* add.Click += delegate
