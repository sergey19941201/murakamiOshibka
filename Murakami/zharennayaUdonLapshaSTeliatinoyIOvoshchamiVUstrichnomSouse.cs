...
namespace Murakami
{
    [Activity(Label = "zharennayaUdonLapshaSTeliatinoyIOvoshchamiVUstrichnomSouse")]
    public class zharennayaUdonLapshaSTeliatinoyIOvoshchamiVUstrichnomSouse : Activity
    {
